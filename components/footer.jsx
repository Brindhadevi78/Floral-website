    ...
    <footer className="bg-slate-900 border-t border-slate-700 py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold text-lg mb-4">Quick Link&apos;s</h4>
            <ul className="space-y-2">
              ...
              <li>
                <a href="#plants" className="text-gray-400 hover:text-green-400 transition">
                  Types of plants
                </a>
              </li>
              <li>
          ...
          {/* Newsletter */}
          <div>
            <h4 className="font-bold text-lg mb-4">For Every Update.</h4>
        ...
        <div className="border-t border-slate-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">© 2025 FloraVision. All rights reserved.</p>
